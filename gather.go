...
// func consume(graph *InMemoryGraph) {
// 	if isCoordinator {
// 		if consumeData {
...
// func getDataCovid19(seconds time.Duration, graph *InMemoryGraph) {
// 	dateTime := time.Now()
...
// func getDataBitcoin(seconds time.Duration, graph *InMemoryGraph) {
// 	dateTime := time.Now()
...
// func getDataOgre(seconds time.Duration, graph *InMemoryGraph) {
// 	dateTime := time.Now()
